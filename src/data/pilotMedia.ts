...
export const pilotMediaMap: Record<string, PilotMedia> = {
  ...
  'xiaolin village microgrid': {
    ...
    timeline: [
      { phase: 'Microgrid foundation', year: '2009-2022', description: 'Pre-V2G phase: village reconstruction, distributed PV and battery rollout, intelligent microgrid dispatch, and islanded blackout resilience are established, but no bidirectional EV integration is described.' },
      { phase: 'V2G research begins', year: '2024', description: 'First V2G-related work at Xiaolin: an IEEE study adds bidirectional EV charging to the microgrid and compares AC and DC coupled V2G configurations for frequency and voltage ancillary services.' },
    ],

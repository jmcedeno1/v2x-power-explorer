...
const marketPlayers = [{
  ...
  players: [{
    ...
    country: '🇩🇰',
    investment: '$180M',
    focus: 'Fleet V2G aggregation'
  }, {
    name: 'Fermata Energy',
    country: '🇬🇧',
    investment: '$65M',
    focus: 'Commercial V2B'
  }, {
    name: 'Wallbox',
    country: '🇪🇸',
    investment: '$450M',
  ...
  players: [{
    ...
    country: '🇺🇸',
    investment: '$500M+',
    focus: 'Integrated F-150 Lightning'
  }, {
    name: 'GM Energy',
    country: '🇺🇸',
    investment: '$750M',
    focus: 'Ultium-based V2H/V2G'
  }]
}, {
  region: 'Asia Pacific',
  players: [{
    ...
    country: '🇯🇵',
    investment: '$200M',
    focus: 'CHAdeMO V2H pioneer'
  }, {
    name: 'Hyundai/Kia',
    country: '🇰🇷',
    investment: '$350M',
    focus: 'V2L & V2G integration'
  }, {
    name: 'BYD',
    country: '🇨🇳',
    investment: '$600M',
    focus: 'Integrated energy ecosystem'
  }, {
    name: 'CATL',
    country: '🇨🇳',
    investment: '$1.2B',
    focus: 'Battery + grid services'
  }]
}];
